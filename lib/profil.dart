            ...
            child: Center(
              child: Column(
                children: <Widget>[
                  ...
                  text("Rijal Ahmad Janani", 32),
                  const Padding(padding: EdgeInsets.only(bottom: 5)),
                  text("rijalahmadjanani@gmail.com", 16),
                  const Padding(padding: EdgeInsets.only(bottom: 5)),
                  text("Rijal.065119062@unpak.ac.id", 16),
                  const Padding(padding: EdgeInsets.only(bottom: 5)),
                  text("085776502034", 16),
                  ...
                  Container(
                    ...
                    child: Column(
                        ...
                        children: const <Widget>[
                          ...
                          Text(
                              "Sukaraja Kaum Rt 02/07 no 51 Kecamatan Sukaraja,     ",
                              style: TextStyle(
                                color: Colors.grey,
                                fontSize: 14,
                                fontWeight: FontWeight.bold,
